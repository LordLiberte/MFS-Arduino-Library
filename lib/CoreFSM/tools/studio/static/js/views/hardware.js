    ...
    h("div", { class: "view-head" },
      h("div", {},
        ...
        h("p", {}, "Declara aquí cada señal física una sola vez. El código usará ",
          h("code", { class: "mono" }, "HW.Nombre"), " y no volverá a ver un número de pin. Arrastra una fila al editor para insertar su expresión.")),
      h("span", { class: "spacer" })),
    h("div", { class: "view-body" }, bar, grid.el));
}
