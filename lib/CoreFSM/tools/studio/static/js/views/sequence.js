...
export function renderSequence() {
  ...
  const wrap = h("div", { class: "view-body", style: { display: "grid", gridTemplateColumns: "minmax(0,1fr) 372px", gap: "14px", alignItems: "start" } },
    h("div", {},
      gridToolbar({ title: "Pasos", count: model.states.length }),
      steps.el,
