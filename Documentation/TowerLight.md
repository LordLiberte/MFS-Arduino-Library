...
Es la única llamada que enciende los tres a la vez, y es legítima: **es
obligatoria en muchas normas de máquina** y es de sentido común. Una baliza con
el rojo fundido es peor que no tener baliza, porque transmite seguridad falsa.
Se hace al arrancar, un segundo, y el operario ve que los tres funcionan.
